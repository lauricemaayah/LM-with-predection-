...
We dismiss the zero hypothesis, and assume that model 3 is greater than the model.2 The P value for the relation is 0.000004994. The adjusted R is 0,54 and the adjusted Model1 is 0,47, while the greater adjusted R square is 0,47 for the Model3.